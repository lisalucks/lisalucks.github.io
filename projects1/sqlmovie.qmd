---
title: Movie Analysis using SQL
...
> Using the list from the Box Office Mojo [^2], I manually created tables with some headings. The code for this project is adapted from Medium's article [^3] regarding movies and databases.

::: {.callout-tip}
## What was derived?
* 2009 produced a batch of one of the most sucessful movies, including Avatar which ranked the highest in gross income; this also went on as a series. 
...
* Popular directors such as James Cameron (Director of Avatar and Titanic) and Anthony and Joe Russo bring the largest revenue in regards to movies.
...
Sourcing for code from following websites as well as footnotes above.
